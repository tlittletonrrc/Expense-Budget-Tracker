...
export async function getAllAccounts(UserID: string, sessionToken: any): Promise<BankAccount[]> {
...
export async function createAccount(newAccount: BankAccount, sessionToken: any): Promise<BankAccount> {
...
export async function deleteAccount(accountId: number, sessionToken: any): Promise<void> {
